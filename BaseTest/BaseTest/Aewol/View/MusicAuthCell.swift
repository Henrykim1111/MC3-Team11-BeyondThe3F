        ...
        func body(content: Content) -> some View {
            content
                .sheet(isPresented: $presentationCoordinator.isWelcomeViewPresented) {
                    MusicAuthView(musicAuthorizationStatus: $presentationCoordinator.musicAuthorizationStatus)
...
extension View {
    func musicAuthViewSheet() -> some View {
        modifier(MusicAuthView.SheetPresentationModifier())
    }
}

// MARK: - Previews

struct MusicAuthView_Previews: PreviewProvider {
    static var previews: some View {
        MusicAuthView(musicAuthorizationStatus: .constant(.notDetermined))
    }
}
